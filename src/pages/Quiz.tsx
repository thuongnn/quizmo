import { Card, Button, Typography, Space, message, Progress, Modal, Checkbox, Radio } from 'antd';
import { CheckCircleOutlined, CloseCircleOutlined, ReloadOutlined, SoundOutlined } from '@ant-design/icons';
import type { Question } from '../types/quiz';
import { getQuestionsByCourseId, getQuizState, saveQuizState, resetQuizState } from '../utils/storage';
